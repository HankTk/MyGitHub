...
@Component({
  selector: 'gx-daterange-calendar',
  templateUrl: './gx-calendar.component.html',
  host: {
    'class': 'mat-calendar',
  },
  exportAs: 'GxDateRangeCalendarComponent',
  encapsulation: ViewEncapsulation.None,
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class GxDateRangeCalendarComponent<D> extends MatCalendar<D> {
